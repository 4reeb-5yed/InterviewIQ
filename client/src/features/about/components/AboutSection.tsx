...
const CONNECT = [
  ...
  { Icon: Mail, label: "Email", value: "areeb.syed1@outlook.com", href: "mailto:areeb.syed1@outlook.com", external: false },
  { Icon: Mail, label: "Email", value: "4reeb.5yed@gmail.com", href: "mailto:4reeb.5yed@gmail.com", external: false },
];
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
        ...
        <CardBody className="space-y-6">
          <div>
            ...
            <div className="mt-3 space-y-3 text-sm font-normal leading-relaxed text-slate-600 dark:text-slate-300">
              <p>
                InterviewIQ is an AI-powered career intelligence platform designed to help candidates
                better understand their résumés through structured, evidence-based analysis.
              </p>
              <p>
                The current version combines résumé parsing, recruiter-style evaluation, ATS insights,
                optional job matching, skill gap analysis, and interview question generation into a
                unified workflow.
              </p>
              <p>
                The primary goal of this project is to explore how modern AI can assist candidates by
                providing transparent reasoning and actionable insights rather than simple keyword
                matching.
              </p>
              <p>
      ...
      <Card>
        <CardBody className="space-y-6">
          <div>
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Developer</h2>
            ...
            <p className="mt-3 text-sm font-normal leading-relaxed text-slate-600 dark:text-slate-300">
              I&apos;m passionate about building practical AI applications that combine modern language
              models, backend engineering, and intuitive user experiences. InterviewIQ is one of my
              ongoing projects where I explore how AI can assist candidates with résumé analysis,
